...
%     3 - Plot results.
%
% Relies on of the Iterate_Value_Function functions.
...
for iteration = 2:number_of_iterations
    ...
    for kt0_index = 1:number_of_k_values
        for zt_index = 1:number_of_z_values
            ...
            %[V, g] = Iterate_Value_Function_v1(Value_Function(:,:,iteration-1), kt0_index, zt_index, params);
            [V, g] = Iterate_Value_Function_v2(Value_Function(:,:,iteration-1), kt0_index, zt_index, params);
